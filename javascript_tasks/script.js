...
function q3enqueue() {
    document.getElementById("s1").value += " "+document.getElementById("q3").value
    document.getElementById("clear3").style.display = "block";
}
function q3dequeue() {
	document.getElementById("s2").value += " "+document.getElementById("q3").value
    document.getElementById("clear3").style.display = "block";
}
	...
	for (i = 0; i <= 100; i++) {
		if (i % 3 == 0) {
			document.getElementById("4").innerHTML =
				document.getElementById("4").innerHTML + "<br>fizz";
		}
		if (i % 5 == 0) {
			document.getElementById("4").innerHTML =
				document.getElementById("4").innerHTML + "<br>buzz";
		}
		if (i % 3 == 0 && i % 5 == 0) {
			document.getElementById("4").innerHTML =
				document.getElementById("4").innerHTML + "<br>fizzbuzz";
		}
	}
...
function q6(){
    var str = document.getElementById("q6").innerHTML
